    ...
    <section class="menu">
        ...
        <div class="items">
            <ul>
                ...
                <li class = "active"><a href="admin_blogs.php"><i class="bi bi-pencil-square"> Blogs</i></a></li>
            ...
            <div class="card" style="margin-top: 2%;margin-bottom: 2%;margin-left: 5%;margin-right: 5%;">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <a href="post.php?id=<?php echo $row['title']; ?>&id2=<?php echo $row["posted"]; ?>"
                            class="btn btn-dark">See
                            post</a>
                    </div>
                </div>
            </div>
